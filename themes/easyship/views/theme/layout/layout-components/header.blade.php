    ...
    <nav id="navigation" class="navbar dropdown-light" aria-label="primary" >
        <div class="container">
            ...
            <div class="d-flex justify-content-center align-items-center">
                <div  class="logo site--logo" style="justify-content:center; margin:auto">
                    <a href="{{ fr_route('home') }}" rel="home" title="{{ config('app.name') }}">
                        <img width="100" src="{{ theme_setting_image('header','header_logo') != '' ? theme_setting_image('header','header_logo') : asset('assets/lte/cargo-logo-small-h38.svg') }}" alt="{{ config('app.name') }}" />
                    </a>
                </div>
