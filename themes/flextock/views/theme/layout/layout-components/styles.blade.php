...
<link rel="stylesheet" id="kolyoum-default-css" href="{{ asset('themes/easyship/assets/css/bootstrap.min.css') }}" />
...
<link rel="stylesheet" href="{{ asset('themes/flextock/assets/css/style.css') }}" />

<link rel="stylesheet" id="kolyoum-default-css" href="{{ asset('themes/easyship/assets/css/post.style.css') }}" type="text/css" media="all" />
<link rel="stylesheet" id="kolyoum-default-css" href="{{ asset('themes/flextock/assets/css/post.style.css') }}" type="text/css" media="all" />
...
@if (isset($current_lang) && $current_lang->dir == 'rtl')
    <link rel="stylesheet" href="{{ asset('themes/flextock/assets/css/rtl.css') }}" />
@endif
