            ...
            <div class="qodef-grid-item">
              <div id="block-23" class="widget widget_block widget_media_image"
                ...
                <figure class="wp-block-image size-full">
                  <a style="max-width: 14rem" href="/"><img decoding="async"
                      src="web/wp-content/uploads/2025/01/white-logo.png" alt="d" class="wp-image-2178" /></a>
                </figure>
              </div>
            </div>
            <div class="qodef-grid-item">
              <div id="nav_menu-2" class="widget widget_nav_menu" data-area="qodef-footer-middle-area-column-2">
                ...
                <div class="menu-footer-column-2-container">
                  <ul id="menu-footer-column-2" class="menu">
                    <li id="menu-item-937" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-937">
      ...
      <div id="qodef-page-footer-bottom-area-inner" class="qodef-content-grid qodef-layout--predefined">
        <div class="qodef-grid qodef-layout--columns qodef-responsive--custom qodef-col-num--2">
          <div class="qodef-grid-inner clear">
            ...
            <div class="qodef-grid-item">
              <div id="globefarer_core_social_icons_group-5" class="widget widget_globefarer_core_social_icons_group"
