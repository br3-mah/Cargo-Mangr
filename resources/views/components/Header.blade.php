                ...
                <div
                  ...
                  <span class="qodef-m-list-title"> <a itemprop="url" href="tel:+260 763 297 287" target="_self"> <span
                        class="qodef-m-list-title-inner"> <span class="qodef-m-list-title-icon"> <img decoding="async"
                            width="15" height="15" src="web/wp-content/uploads/2021/08/Phone-Icon-2-1.png"
          ...
          <div
            ...
            <span class="qodef-m-list-title"> <a itemprop="url" href="mailto:info@newworldcargo.com" target="_self"> <span
                  class="qodef-m-list-title-inner"> <span class="qodef-m-list-title-icon"> <img loading="lazy" width="18"
                      height="12" src="web/wp-content/uploads/2021/08/Mail-Icon-1-1.png" class="attachment-full size-full"
...
<header id="qodef-page-header" role="banner">
  <div id="qodef-page-header-inner" class="qodef-skin--light qodef-header-cursor--light">
    <a itemprop="url" class="qodef-header-logo-link qodef-height--set qodef-source--image" href="{{ route('home') }}" rel="home">
      ...
      <ul id="menu-main-menu-1" class="menu">
        ...
        <li
          ...
          <a onclick="JavaScript: return false;"><span class="qodef-menu-item-text">About Us
        ...
        <li
          ...
          <a onclick="JavaScript: return false;"><span class="qodef-menu-item-text">Services<svg
                class="qodef-svg--menu-arrow qodef-menu-item-arrow" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" width="8.485" height="14.14" viewBox="0 0 8.485 14.14">
                <path d="M0,0H10V2H0Z" transform="translate(8.485 7.069) rotate(135)" />
                <path d="M0,0H10V2H0Z" transform="translate(7.071 8.485) rotate(-135)" />
        ...
        <li
          ...
          <a onclick="JavaScript: return false;"><span class="qodef-menu-item-text">Contact<svg
                class="qodef-svg--menu-arrow qodef-menu-item-arrow" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" width="8.485" height="14.14" viewBox="0 0 8.485 14.14">
                <path d="M0,0H10V2H0Z" transform="translate(8.485 7.069) rotate(135)" />
                <path d="M0,0H10V2H0Z" transform="translate(7.071 8.485) rotate(-135)" />
    ...
    <div class="qodef-widget-holder qodef--one">
      <div class="widget widget_globefarer_core_order_tracking" data-area="header-light">
        <div class="qodef-order-tracking">
          <div class="qodef-m-opener">
            <svg class="qodef-svg--flag qodef-m-opener-icon" xmlns="http://www.w3.org/2000/svg"
              xmlns:xlink="http://www.w3.org/1999/xlink" width="18" height="22" viewBox="0 0 18 22">
              <g transform="translate(-1811.5 -48)">
                <path d="M0,0H13.391L11.4,2H0Z" transform="translate(1815.5 50)" />
                <path d="M0,0H8V2H0Z" transform="translate(1811.5 68)" />
                <path d="M0,0H11.533l1.92,2H0Z" transform="translate(1815.5 58)" />
                <path d="M0,0,6.983-.017,9,2H0Z" transform="translate(1821.636 54.95) rotate(-45)" />
                <path d="M0,0,9.121.021,7.11,2.032,0,2Z" transform="translate(1823.05 53.536) rotate(45)" />
      ...
      <div class="widget widget_globefarer_core_side_area_opener" data-area="header-light">
        <a href="javascript:void(0)" class="qodef-opener-icon qodef-m qodef-source--predefined qodef-side-area-opener"
          ...
          <span class="qodef-m-icon qodef--open">
            <svg class="qodef-svg--menu" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
  ...
  <div class="qodef-header-sticky qodef-custom-header-layout qodef-appearance--down">
    <div class="qodef-header-sticky-inner">
      ...
      <div class="qodef-widget-holder qodef--one">
        <div id="globefarer_core_side_area_opener-6"
...
<header id="qodef-page-mobile-header" role="banner">
  <div id="qodef-page-mobile-header-inner" class="">
    ...
    <a href="javascript:void(0)" class="qodef-opener-icon qodef-m qodef-source--predefined qodef-mobile-header-opener">
      ...
      <span class="qodef-m-icon qodef--close">
        <svg class="qodef-svg--close" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
          width="19.778" height="19.778" viewBox="0 0 19.778 19.778">
          <g transform="translate(-30 -30)">
            <rect width="13" height="2" transform="translate(31.414 30) rotate(45)" />
            <rect width="13" height="2" transform="translate(48.364 49.778) rotate(-135)" />
            <rect width="13" height="2" transform="translate(30 48.364) rotate(-45)" />
            <rect width="13" height="2" transform="translate(49.778 31.414) rotate(135)" />
          </g>
        </svg>
      </span>
    </a>
  ...
  <nav class="qodef-mobile-header-navigation" role="navigation" aria-label="Mobile Menu">
    <ul id="menu-main-menu-4" class="">
      ...
      <li
        class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-7705 qodef--hide-link qodef-menu-item--narrow">
        <a onclick="JavaScript: return false;"><span class="qodef-menu-item-text">Pages</span></a><svg
          class="qodef-svg--menu-arrow qodef-menu-item-arrow" xmlns="http://www.w3.org/2000/svg"
          xmlns:xlink="http://www.w3.org/1999/xlink" width="8.485" height="14.14" viewBox="0 0 8.485 14.14">
          <path d="M0,0H10V2H0Z" transform="translate(8.485 7.069) rotate(135)" />
          <path d="M0,0H10V2H0Z" transform="translate(7.071 8.485) rotate(-135)" />
      ...
      <li
        class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-7706 qodef--hide-link qodef-menu-item--narrow">
        <a onclick="JavaScript: return false;"><span class="qodef-menu-item-text">Services</span></a><svg
          class="qodef-svg--menu-arrow qodef-menu-item-arrow" xmlns="http://www.w3.org/2000/svg"
          xmlns:xlink="http://www.w3.org/1999/xlink" width="8.485" height="14.14" viewBox="0 0 8.485 14.14">
          <path d="M0,0H10V2H0Z" transform="translate(8.485 7.069) rotate(135)" />
          <path d="M0,0H10V2H0Z" transform="translate(7.071 8.485) rotate(-135)" />
      ...
      <li
        class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-7708 qodef--hide-link qodef-menu-item--narrow">
        <a onclick="JavaScript: return false;"><span class="qodef-menu-item-text">Contact</span></a><svg
          class="qodef-svg--menu-arrow qodef-menu-item-arrow" xmlns="http://www.w3.org/2000/svg"
          xmlns:xlink="http://www.w3.org/1999/xlink" width="8.485" height="14.14" viewBox="0 0 8.485 14.14">
          <path d="M0,0H10V2H0Z" transform="translate(8.485 7.069) rotate(135)" />
          <path d="M0,0H10V2H0Z" transform="translate(7.071 8.485) rotate(-135)" />
