...
<div class="container kt-container mt-5 pt-8">
    <div class="card kt-card shadow-sm border-0">
        <div class="card-body kt-card-body p-5">
            ...
            <button class="btn btn-warning kt-btn fw-bold">Report Suspicious Email</button>
            ...
            <p class="kt-text text-danger fw-bold">Newworld Cargo is not responsible for costs incurred due to fraud.</p>
            
            <button class="btn btn-danger kt-btn">Download Anti-Spam Protection Initiative (PDF - 674.6 KB)</button>
        </div>
    </div>
</div>
