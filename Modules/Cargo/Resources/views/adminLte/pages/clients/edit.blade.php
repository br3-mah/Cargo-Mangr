...
@section('pageTitle')
    {{ __('cargo::view.edit_clients') }} - {{ $model->name }}
@endsection
...
@section('content')
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div>
            <!--begin::Form-->
            <form id="kt_account_profile_details_form" class="form" action="{{ fr_route('clients.update', ['client' => $model->id]) }}" method="post" enctype="multipart/form-data">
                @method('PUT')
                <!--begin::Card body-->
                <div class="card-body border-top p-9">
                    @include('cargo::adminLte.pages.clients.form', ['typeForm' => 'edit',])
                </div>
                <!--end::Card body-->
                <!--begin::Actions-->
