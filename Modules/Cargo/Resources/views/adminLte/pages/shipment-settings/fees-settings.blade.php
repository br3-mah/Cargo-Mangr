                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" min="0" id="name" class="form-control" placeholder="{{ __('cargo::view.default_insurance') }}" value="{{Modules\Cargo\Entities\ShipmentSetting::getVal('def_insurance')}}" name="Setting[def_insurance]" >
                                </div>
