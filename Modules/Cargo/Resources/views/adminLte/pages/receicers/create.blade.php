...
@section('pageTitle')
    {{ __('cargo::view.create_new_Receiver') }}
@endsection
...
@section('content')
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div>
            <!--begin::Form-->
            <form id="kt_account_profile_details_form" class="form" action="{{ fr_route('receiver.store') }}" method="post" enctype="multipart/form-data">
                <!--begin::Card body-->
