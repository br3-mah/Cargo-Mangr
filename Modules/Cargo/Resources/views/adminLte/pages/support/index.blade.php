                    ...
                    <div class="table-responsive">
                        <table class="table table-head-custom table-vertical-center" id="kt_my_support_tickets_table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><span class="text-dark-75 font-weight-bold">#SUP-12340</span></td>
                                    <td>Inquiry about Dubai Shipping</td>
                                    <td><span class="label label-lg label-light-success label-inline">Resolved</span></td>
                                    <td>2025-02-28</td>
                                    <td>2025-03-02</td>
                                    <td>
                    ...
                    <div class="accordion accordion-light accordion-toggle-arrow" id="faqAccordion">
                        <div class="card">
                            ...
                            <div id="faqCollapse1" class="collapse" data-parent="#faqAccordion">
                                <div class="card-body">
                                    You can track your shipment by logging into your account dashboard and navigating to the "Shipments" section. Enter your tracking number to get real-time updates on your package's location and estimated delivery time.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-header" id="faqHeading2">
                                <div class="card-title collapsed" data-toggle="collapse" data-target="#faqCollapse2">
                                    What are your shipping rates from China to Zambia?
                                </div>
                            </div>
                            <div id="faqCollapse2" class="collapse" data-parent="#faqAccordion">
                                <div class="card-body">
                                    Our shipping rates from China to Zambia depend on the weight, dimensions, and shipping method. For air freight, rates start at $X per kg, while sea freight is calculated by CBM (cubic meter). Contact our customer service for a detailed quote based on your specific needs.
                                </div>
                            </div>
                        </div>
