...
<!--begin::Input group --  Cost -->
<div class="row mb-6">
    <!--begin::Label-->
    <label class="col-lg-4 col-form-label required fw-bold fs-6">{{ __('cargo::view.table.cost') }}</label>
    <!--end::Label-->

    <!--begin::Input group-->
    <div class="col-lg-8 fv-row">
        <div class="input-group mb-4">
            <input type="number" min="0" name="cost" class="form-control form-control-lg @error('cost') is-invalid @enderror" placeholder="{{ __('cargo::view.table.cost') }}" value="{{ old('cost', isset($model) ? $model->cost : 0 ) }}" />
            @error('cost')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
