...
<style>
    ...
    @keyframes pulse {
        0% {
            box-shadow: 0 0 0 0 rgba(185, 137, 16, 0.7);
        }

        70% {
            box-shadow: 0 0 0 10px rgba(185, 148, 16, 0);
        }

        100% {
            box-shadow: 0 0 0 0 rgba(185, 154, 16, 0);
        }
    }
    ...
    .notification-close:hover {
        background-color: rgba(185, 160, 16, 0.12);
        opacity: 1;
    }

    .notification-close:focus {
        outline: none;
        box-shadow: 0 0 0 2px rgba(185, 157, 16, 0.5);
    }
...
<script>
    ...
    const notification = document.querySelector('.warning-notification');
    if (notification) {
        setTimeout(() => {
